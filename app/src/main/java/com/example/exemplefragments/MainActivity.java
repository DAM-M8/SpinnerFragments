 ...
 * Activitat basada amb l'exemple de Fragments disponible a Android Studio que mostra com a
 * resultat la seleccio d'un desplegable (Spinner) utilitzant un Toast */
